...
class OrdersModelsTests(TestCase):
    ...
    def test_retations_order_and_products(self):
        ...
        products_order = len(order_client_test[3].products.all())
        number_products_expected = 3
        self.assertEqual(products_order, number_products_expected)
