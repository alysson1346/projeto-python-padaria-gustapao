...
class ProductViewsTests(APITestCase):
    ...
    def test_create_product_without_authorization(self):
    ...
    def test_anyone_can_list_products(self):
        ...
        response = self.client.get(self.base_product_url)
    ...
    def test_staff_can_create_product(self):
        token = self.staff_token.__dict__["key"]
        self.client.credentials(HTTP_AUTHORIZATION='Token ' + token)
    ...
    def test_if_product_can_be_created_with_same_atributes(self):
        token = self.staff_token.__dict__["key"]
        self.client.credentials(HTTP_AUTHORIZATION='Token ' + token)
    ...
    def test_any_user_can_retrieve_product(self):

        expected_status_code = status.HTTP_200_OK

        response = self.client.get(self.base_product_manage_details_url)

        self.assertEquals(expected_status_code, response.status_code)

    def test_product_cannot_be_updated_without_authorization(self):
        ...
        response = self.client.patch(self.base_product_manage_details_url, data=test_request, format='json')

        self.assertEquals(expected_status_code, response.status_code)

    def test_common_user_cannot_update_product(self):
        token = self.common_token.__dict__["key"]
        self.client.credentials(HTTP_AUTHORIZATION='Token ' + token)
    ...
    def test_product_cannot_be_deleted_without_authorization(self):
        ...
        response = self.client.delete(self.base_product_manage_details_url, data=test_request, format='json')

        self.assertEquals(expected_status_code, response.status_code)

    def test_common_user_cannot_delete_product(self):
        token = self.common_token.__dict__["key"]
        self.client.credentials(HTTP_AUTHORIZATION='Token ' + token)
    ...
    def test_admin_can_delete_product(self):
        ...
        response = self.client.delete(self.base_product_manage_details_url)
